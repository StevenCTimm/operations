...
#### FermiGrid Ops
   * No changes on our side this week.  Helping Scott with dumps of VOMS OSG database and with testing.
...
#### FermiGrid Ops
   * Nothing in plans except for aiding with OSG Voms transition.
